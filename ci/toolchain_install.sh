...
riscv32()
{
    ...
    *)          parts=$(eval echo {a..j}) ;;
    ...
    mkdir -p $TOOLDIR && rm -rf $TOOLDIR/riscv32-gnu-toolchain && mv riscv32-gnu-toolchain $RISCV_TOOLCHAIN_PATH
...
riscv64()
{
    ...
    *)          parts=$(eval echo {a..j}) ;;
    ...
    mkdir -p $TOOLDIR && rm -rf $TOOLDIR/riscv64-gnu-toolchain && mv riscv64-gnu-toolchain $RISCV_TOOLCHAIN_PATH
